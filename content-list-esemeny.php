	...
	<div class="blog-item-wrap">
		<div class="post-inner-content">
			<header class="entry-header page-header">
				<h2 class="entry-title text-left"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
				...
				<?php endif; ?>
                        ...
                        <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
                                <?php the_post_thumbnail( 'two', ['class' => 'img-responsive img-esemeny-list'] ); ?>
                        </a>
